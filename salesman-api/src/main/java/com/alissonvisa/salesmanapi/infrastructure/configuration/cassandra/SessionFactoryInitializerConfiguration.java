package com.alissonvisa.salesmanapi.infrastructure.configuration.cassandra;

import com.alissonvisa.salesmanapi.infrastructure.repository.cassandra.SpringDataCassandraSalesmanRepository;
...
@Configuration
@EnableCassandraRepositories(basePackageClasses = SpringDataCassandraSalesmanRepository.class)
public class SessionFactoryInitializerConfiguration extends AbstractCassandraConfiguration {
    ...
    @Bean
    SessionFactoryInitializer sessionFactoryInitializer(SessionFactory sessionFactory) throws Exception {
