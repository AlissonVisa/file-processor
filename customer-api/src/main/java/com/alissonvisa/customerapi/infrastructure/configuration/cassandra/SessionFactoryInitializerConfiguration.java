...
import com.alissonvisa.customerapi.infrastructure.repository.cassandra.CassandraDbCustomerRepository;
...
@Configuration
@EnableCassandraRepositories(basePackageClasses = CassandraDbCustomerRepository.class)
